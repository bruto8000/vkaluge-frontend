  ...
  <div id='profile'>
    ...
    <header class="header">
      ...
      <div class="header-actions">
        ...
        <!-- MOBILEMENU TRIGGER -->
        <div @click='needSidebar=!needSidebar' class="mobilemenu-trigger navigation-widget-mobile-trigger">
          <!-- BURGER ICON -->
      ...
      <div class="header-actions search-bar">
        ...
        <div class="interactive-input dark">
          <input
            ...
            id="search-main"
            name="search_main"
            placeholder="Найдите людей и группы"
          />
      ...
      <div class="header-actions">
        ...
        <div class="action-item-wrap">
          <!-- ACTION ITEM -->
          <div @click="needSidebar=true" class="action-item dark header-settings-dropdown-trigger">
            <!-- ACTION ITEM ICON -->
        ...
        <div class="profile-header-info">
          ...
          <div class="user-short-description big">
            ...
            <p class="user-short-description-title">
              <a href="profile-timeline.html">{{user.firstName}} {{user.lastName}}</a>
            </p>
            <!-- /USER SHORT DESCRIPTION TITLE -->
   ...
   <sidebar :value.sync='needSidebar'></sidebar>
      <!-- /GRID -->
    </div>
    <!-- /CONTENT GRID -->
  </div>
...
<script>
import sidebar from './every/sidebar.vue'
export default {
...
let dateWas = new Date(this.user.lastAction);




      return Math.abs((dateNow - dateWas)/1000);
    }
  },
  components:{
    sidebar
