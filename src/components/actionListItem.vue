...
<div>
  <div class="action-list-item-wrap">
          <!-- ACTION LIST ITEM -->
          <div class="action-list-item unread header-dropdown-trigger" :id="id+'trigger'">
          ...
          <!-- DROPDOWN BOX -->
          <div class="dropdown-box header-dropdown" :id='id'>
            <!-- DROPDOWN BOX HEADER -->
            <div class="dropdown-box-header">
              <!-- DROPDOWN BOX HEADER TITLE -->
              <p class="dropdown-box-header-title">Сообщения</p>
              <!-- /DROPDOWN BOX HEADER TITLE -->
