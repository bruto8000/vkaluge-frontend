<template>
  ...
  <header class="header row">
    ...
    <!-- HEADER ACTIONS -->
    <div class="col-4 header-actions">
      ...
      <!-- /MOBILEMENU TRIGGER -->
      <sidebar-Part screen="desktop"></sidebar-Part>
      <!-- NAVIGATION -->

  <!-- NAVIGATION WIDGET -->
    <sidebar-Part screen="mobile"></sidebar-Part>
  <!-- /NAVIGATION WIDGET -->
      ...
      <div class="header-brand">
        ...
        <!-- HEADER BRAND TEXT -->
        <h1 class="header-brand-text">VKALUGE</h1>
        <!-- /HEADER BRAND TEXT -->
      </div>
      <!-- /HEADER BRAND -->
    </div>
    ...
    <!-- HEADER ACTIONS -->
    <div class="col-4 header-actions search-bar ">
      <!-- INTERACTIVE INPUT -->
      <div class="interactive-input dark">
        <input
          ...
          id="search-main"
          name="search_main"
          placeholder="Найти друзей, группы и много чего"
        />
      ...
      <div class="dropdown-box padding-bottom-small header-search-dropdown">
        ...
        <div class="dropdown-box-category">
          ...
          <p class="dropdown-box-category-title">Опа а тут будет подгрузка с сервера</p>
          <!-- /DROPDOWN BOX CATEGORY TITLE -->
        </div>
        <!-- /DROPDOWN BOX CATEGORY -->
        ...
        <div class="dropdown-box-list small no-scroll">
          ...
          <a class="dropdown-box-list-item" >
            <!-- USER STATUS -->
            <div class="user-status notification">
              ...
              <p class="user-status-title">
                <span class="bold">Дрочун</span>
              </p>
              <!-- /USER STATUS TITLE -->

              <!-- USER STATUS TEXT -->
              <p class="user-status-text">1 общий друг-дрочун</p>
              <!-- /USER STATUS TEXT -->
          ...
          <a class="dropdown-box-list-item">
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Другой дрочун</span>
              </p>
              <!-- /USER STATUS TITLE -->

              <!-- USER STATUS TEXT -->
              <p class="user-status-text">4 общих друзей</p>
              <!-- /USER STATUS TEXT -->
        ...
        <div class="dropdown-box-category">
          <!-- DROPDOWN BOX CATEGORY TITLE -->
          <p class="dropdown-box-category-title">Девушки</p>
          <!-- /DROPDOWN BOX CATEGORY TITLE -->
        </div>
        <!-- /DROPDOWN BOX CATEGORY -->
        ...
        <div class="dropdown-box-list small no-scroll">
          ...
          <a class="dropdown-box-list-item" >
            ...
            <div class="user-status notification">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Девушка-дрочун</span>
              </p>
              <!-- /USER STATUS TITLE -->

              <!-- USER STATUS TEXT -->
              <p class="user-status-text">139 побывавших</p>
              <!-- /USER STATUS TEXT -->
    ...
    <!-- HEADER ACTIONS -->
    <div class="col-4 header-actions justify-content-end">
      <!-- ACTION LIST -->
            ...
            <div class="dropdown-box-list no-hover" data-simplebar>
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status request">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title">
                    <a class="bold" href="profile-timeline.html">Paul Lang</a>
                  </p>
                  <!-- /USER STATUS TITLE -->
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status request">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title">
                    <a class="bold" href="profile-timeline.html">Cassie May</a>
                  </p>
                  <!-- /USER STATUS TITLE -->
            ...
            <div class="dropdown-box-list" data-simplebar>
              ...
              <div class="dropdown-box-list-item">
                ...
                <div class="user-status notification">
                  ...
                  <!-- USER STATUS TITLE -->
                  <p class="user-status-title">
                    <a class="bold" href="profile-timeline.html">Destroy Dex</a>
                    posted a comment on your
        ...
        <div class="dropdown-navigation header-settings-dropdown">
          ...
          <div class="dropdown-navigation-header">
            ...
            <div class="user-status">
              ...
              <!-- USER STATUS TITLE -->
              <p class="user-status-title">
                <span class="bold">Привет {{ user.firstName }}</span>
              </p>
              <!-- /USER STATUS TITLE -->

              <!-- USER STATUS TEXT -->
              <p class="user-status-text small">
                <a>тел. {{ user.phoneNumber }}</a>
              </p>
              <!-- /USER STATUS TEXT -->
            </div>
            <!-- /USER STATUS -->
          ...
          <p class="dropdown-navigation-category">Профиль</p>
          <!-- /DROPDOWN NAVIGATION CATEGORY -->

          <!-- DROPDOWN NAVIGATION LINK -->
          <a class="dropdown-navigation-link is-clickable link-secondary"
            >Уведомления</a
          >
          <!-- /DROPDOWN NAVIGATION LINK -->
          ...
          <!-- DROPDOWN NAVIGATION CATEGORY -->
          <p class="dropdown-navigation-category">Аккаунт</p>
          <!-- /DROPDOWN NAVIGATION CATEGORY -->
          ...
          <!-- DROPDOWN NAVIGATION CATEGORY -->
          <p class="dropdown-navigation-category is-clickable link-secondary">
            Группы
          </p>
          <!-- /DROPDOWN NAVIGATION CATEGORY -->
          ...
          <p @click='logout' class="vs-con-loading__container dropdown-navigation-button button small secondary">
            Выход
          </p>
          <!-- /DROPDOWN NAVIGATION BUTTON -->
        </div>
...
<script>
import sidebarPart from "./sidebar-part.vue";
export default {
    mounted(){
